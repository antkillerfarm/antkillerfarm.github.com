...
名称 | 报文 | 函数调用
|:--:|:--:|:--:|
主动告知 | NOTIFY * HTTP/1.1<br/>NTS: ssdp:alive | upnp/src/ssdp/ssdp_device.c: ssdp_handle_device_request<br/>upnp/src/ssdp/ssdp_device.c: advertiseAndReplyThread<br/>upnp/src/ssdp/ssdp_server.c:AdvertiseAndReply<br/>upnp/src/ssdp/ssdp_device.c: DeviceAdvertisement<br/>upnp/src/ssdp/ssdp_device.c: CreateServicePacket<br/>msg_type=MSGTYPE_ADVERTISEMENT


4.辅助函数

SampleUtil_PrintEvent: 这是个事件打印函数，对于分析UPNP的交互流程很有帮助。
