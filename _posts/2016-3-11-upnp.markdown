...
名称 | 报文 | 函数调用
主动告知 | NOTIFY * HTTP/1.1<br/>NTS: ssdp:alive | upnp/src/ssdp/ssdp_device.c: DeviceAdvertisement<br/>upnp/src/ssdp/ssdp_device.c: CreateServicePacket<br/>msg_type=MSGTYPE_ADVERTISEMENT
