...
OpenRA是一个红警开源并现代化的版本，加入了Attack-Move、战雾、单位升级之类的元素。目前支持 Red Alert, Command & Conquer和Dune 2000等三款游戏，这三款正好也是当年WestWood用同一套引擎设计出来的。
