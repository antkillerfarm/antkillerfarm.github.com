...
在早期硬骨鱼类出现，运动能力增强时，它们在消化道内发展出了一个特殊的气囊。这个气囊，可以吞咽空气辅助呼吸，也能调节浮力。
...
鸟类的祖先（兽脚类恐龙）已把心室肌小梁提前密集化，成年个体保留右主动脉弓；

哺乳类的祖先（合弓类）则把动脉圆锥纵向劈开，保留左主动脉弓，并额外演化出窦房结—浦肯野纤维高速传导系统。

虽然解剖细节不同，但功能上都是“左右泵完全隔离＋同步协调”，于是出现了今天看似“一模一样”的四腔心。
