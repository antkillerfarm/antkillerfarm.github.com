...
激光诱导放电（LDP）的方式产生离子体，原理是激光先汽化锡形成蒸气云，再通过高压放电激发等离子体。锡雾呈弥散云状，辐射面积比锡滴大一个量级，功率密度被摊薄，辐射亮度自然也就提不起来。且锡雾均匀性控制困难，导致等离子体密度不均，影响光源稳定性。
...
EUV的光源必须是相干辐射光，SSMB的难点就在于如何保证光的相干性。
