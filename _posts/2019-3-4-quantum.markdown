...
量子通讯，是基于一对纠缠光子，一个光子在观测过程确定自旋方向，另一个也会瞬间确定方向，这是超距作用。这个过程不会传递信息和能量，但这对光子可以对作为一对秘钥，用于对信息的加密。对纠缠光子的产生操作在上个世纪就非常成熟，但在保持量子纠缠的状态下对光子的自旋方向怎么区分，是没有解决的，所以量子通讯一直停留于理论阶段。而潘的工作就是解决了这个，这使得量子通讯成为了现实。

但问题是量子通讯除了安全毫无用处，因为它只是保证信息传递过程中的安全，其他在计算机中的安全完全无法保证。前者在现在几乎不可能出问题，而后者才是主要出现漏洞的地方。这就使得这个技术的应用就被打死了。不能说潘做的没有科学意义，他的确解决了问题，但他明明在做应用，却没有应用市场。

https://www.zhihu.com/question/642824955

在中国科学技术大学网站，搜索”潘建伟“，显示数由6552条变为211条，意味着什么？
...
这里介绍一些仿生物过程/仿物理过程的智能算法。

---

当时流行各种启发式算法，或者说各种动物或者是昆虫组成的算法，比如萤火虫算法，狼群算法，蚁群算法，遗传算法，雁群算法.....

当时搞CS有点像在搞物种大全，甚至当时的杀毒软件也会来蹭一蹭热度..叫启发式杀毒。
...
https://blog.csdn.net/m0_73804764/article/details/140304201
...
樽海鞘群算法( salp swarm algorithm，SSA)是Seyedali Mirjalili等于2017年提出的一种新型智能优化算法。

https://blog.csdn.net/u011835903/article/details/107767869
