...
$$u(t) = K_\text{p} e(t) + K_\text{i} \int_0^t e(\tau) \,d\tau$$
...
**场景3**：假设用户的用水量是变化，即$$c(t)$$。

$$u(t) = K_\text{p} e(t) + K_\text{i} \int_0^t e(\tau) \,d\tau + K_\text{d} \frac{de(t)}{dt}$$
