...
我直接clone了Jekyll开发者兼github联合创始人mojombo的blog数据，我将index.html,post.html等文件一顿乱改，又删除了丫以前的文章，然后git push上去，页面果然出来
了。我虽然不能在本地预览我的文章，但是我可以通过不停的git push来预览，仍然可以装逼的Bloging like a hacker.
