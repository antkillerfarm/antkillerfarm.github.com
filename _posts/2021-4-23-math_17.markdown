...
李发现，连续群是一个空间，每一个元素都可以用矩阵表示，由于连续，所以矩阵相当于一个函数。正如一个抽象曲线（曲面）上的一个点，每个点的导数都具有特别的性质。
...
https://www.zhihu.com/question/356243536
...
16世纪末，弗朗索瓦·韦达（Francois Viete）的出现，强化了法国人破解密码的技能。
...
韦达在1589–1594年间为法王亨利四世破译了大量西班牙密信，其中最著名的案例是1590年破解西班牙指挥官莫罗（Moreo）致菲利普二世的信件。
