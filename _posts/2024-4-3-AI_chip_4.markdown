...
2025年12月，NVIDIA为了规避反垄断监管，与Groq达成了一项价值约200亿美元的非独家技术许可协议，收购Groq的人才+技术。

LPU（Language Processing Unit）采用确定性执行架构和片上SRAM设计，在特定AI推理工作负载下可实现比GPU快10倍的低延迟性能。特点：500MB的超大SRAM，取代HBM。

LPU是decode-specialized的异构协处理器，GPU负责相对动态的prefill与decode attention，LPU负责相对静态的FFN/MoE；可以极大的缓解memory subsystem的压力，提高utilization。
...
https://zhuanlan.zhihu.com/p/684340572
